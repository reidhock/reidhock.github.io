...
published: true
---
Those of you who speak Korean might have realized that I only have been posting about python algorithm quiz. When I started this blog, I wanted my blog to be informative to people who are living out of my country as well. So from now on, I will try to write some of future posts in English.

I didn't learn programming in English. So my terminology might not be perfect or very professional. A bright side is if you aren't a programmer it might be easier to understand since I don't throw some professional terms haha.

## What is Jekyll?
Our friend, wikipedia says
> "Jekyll is a **simple**, **blog-aware**, **static site generator** for personal, project, or organization sites. Written in Ruby by Tom Preston-Werner, GitHub's co-founder, it is distributed under the open source MIT license."

Basically, people use Jekyll because it is light and easy to use. When I use Jekyll first, I didn't know anything about it. But after 1~2 weeks, I found myself making this blog.
...
## Preparation 
By following this post, you are going to post and update a blog by using some tools(SourceTree, Atom, Github) that help you manage your blog easier. Don't get scared to new tools. they are user-friendly and easy-to-use tools. (Maybe not Github...maybe...)
In this part, I am going to go through followings and explain one by one.
...
### Jekyll themes
First, you need to see if you even want to use Jekyll to make your own blog. Go visit following links and see if there is a template that you want to use first.

[http://jekyllthemes.org](http://jekyllthemes.org/)

[https://jekyllthemes.io](https://jekyllthemes.io/)

In my case, I wanted a simple and easy-to-use theme. A theme, [Kiko_Now](https://aweekj.github.io/kiko-now/), is what I am currently using for my blog. I chose this because I didn't have to mess with a new programming language, `Ruby`, and easy to navigate throughout the pages.
...
I highly recommend to read all the tutorials and guides. You don't have to understand but get a sense of it. That is enough for now.
